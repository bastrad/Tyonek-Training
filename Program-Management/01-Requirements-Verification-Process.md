# 01 — Requirements Verification Process
...
> **Starting reference:** the [governing-standards catalog](../References/Governing-Standards-Reference.md)
...
(see `02-Continuous-Improvement-Loop.md`).
