...
```mermaid
flowchart LR
  D[1 - Define<br/>charter & scope] --> M[2 - Measure<br/>collect current state]
  M --> A[3 - Analyze<br/>gaps & root causes]
  A --> I[4 - Improve<br/>findings & actions]
  I --> C[5 - Control<br/>sustain & hand off]
  C -. feeds .-> P[Standing Program<br/>Verify - Train - Assess - Audit]
```
...
```mermaid
gantt
  title Initial Phase — First 30 Days (illustrative, not calendar-bound)
  dateFormat  YYYY-MM-DD
  axisFormat  %b %d
  section Define
  Charter, scope & stakeholders     :2026-01-05, 5d
  section Measure
  Data collection & inventory       :2026-01-08, 10d
  section Analyze
  Current-state mapping & priorities:2026-01-19, 6d
  section Improve
  Findings report & actions         :2026-01-26, 3d
  section Control
  Control plan & handoff            :2026-01-29, 2d
```
