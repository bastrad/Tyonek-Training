...
```mermaid
flowchart TD
  A[Know the work<br/>Phase 2: the jobs] --> B[Know what's required<br/>Phase 3: requirements]
  B --> C[See what we have vs. what's required<br/>Phase 4: discover & analyze the gaps]
  C --> D[Close the gaps<br/>Phase 5: develop, deliver, assess]
  D --> E[Keep it working<br/>Phase 6: sustain & improve]
  E --> B
```
