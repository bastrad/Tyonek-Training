# Continuous Improvement Loop (Train → Assess → Document → Audit)
...
**Inputs:** the verified Requirements Register from [`Requirements-Verification-Process.md`](../3-Requirements/Requirements-Verification-Process.md).
...
[Training Needs / Gap Analysis template](../4-Discover-and-Analyze/templates/Training-Needs-Gap-Analysis.md), which draws
its required list from the [governing-standards catalog](../3-Requirements/Governing-Standards-Reference.md).
