🏠 [Home](../README.md) · ⬆ [Phase 3 · Requirements](README.md)
...
Both the [Gap Analysis worksheet](../4-Discover-and-Analyze/templates/Training-Needs-Gap-Analysis.md)
and the [Requirements Verification process](Requirements-Verification-Process.md)
